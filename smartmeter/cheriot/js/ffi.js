...
export const DATA_PROVIDER_SCHEDULE_RATE_ARRAY = 10;
export const DATA_PROVIDER_VARIANCE_TIMESTAMP_BASE = 11;
export const DATA_PROVIDER_VARIANCE_START = 12;
export const DATA_PROVIDER_VARIANCE_DURATION = 13;
export const DATA_PROVIDER_VARIANCE_RATE = 14;
